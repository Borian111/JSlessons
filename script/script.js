...
/*Вычислить бюджет на месяц, учитывая обязательные расходы,
 ...
 let budgetMonth = parseInt(money) + income - parseInt(aMount1) - parseInt(aMount2);
 ...
 let xMission = mission /((parseInt(money) + income) - budgetMonth);
